<template>
    <div v-if="active" @click.self="colseTermsOfUse" class="modal_background">
        <div class="TermsofuseModal_modal">
            <div>
                <span class="fs_subtitle fw_600">
                    이용약관
                </span>
            <span class="material-icons close_icon fc_gray_05" @click="colseTermsOfUse">close</span>
            </div>
            <br>
            <br>
            <div class="fs_discription fc_gray_03 line_height_160">
                제1조 목적<br>
                <br>
...
export default {
    ...
    methods: {
        colseTermsOfUse() {
            this.$emit('colseTermsOfUse');
        }
    }
}
</script>
<style scoped>
.TermsofuseModal_modal {
    background: white;
    width: 35rem;
    margin: 5rem auto;
    padding: 2rem;
