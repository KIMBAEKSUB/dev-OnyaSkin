<template>
    <div @click.self="colsePrivacyPolicy" class="modal_background" v-if="active">
        <div class="privecy_modal">
            <div>
                <span class="fs_subtitle fw_600">개인정보처리방침</span>
                <span class="material-icons close_icon fc_gray_05" @click="colsePrivacyPolicy">close</span>
            </div>
            <br>
            <br>
            <div class="line_height_160 fs_discription fc_gray_03">
            ...
            <div>
                <button class="button_01" @click="colsePrivacyPolicy">I agree with this</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        colsePrivacyPolicy() {
            this.$emit('colsePrivacyPolicy', false);
        }
    }
}
</script>
